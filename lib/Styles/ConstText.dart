...
class StaticText {
  static String productDummyImage =
      "https://fdn2.gsmarena.com/vv/pics/apple/apple-iphone-12-r1.jpg";
  static String productDummyPrice = "OMR 90.000";
  static String productDummyName = "Apple iphone 12 pro (pacific blue 128gb)";
  static String homeProductslabel = "Mobile Phones";
